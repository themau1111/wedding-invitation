...
import "./Flowers.scss"; // Archivo CSS con las animaciones

const Flowers = (isLoaded:any) => {
  return (
    <div style={{
        width: "15em",
        zIndex: 2000000000,
        left: "10em",
        top: "43em",
        position: "absolute", // Asegúrate de que sea absoluta para que `left` y `top` funcionen.
      }}
